...
class DownRobotStateTest {
    ...
    @Test
    void getName() {
        assertEquals("DOWN", state.getName());
    }
    ...
    @Test
    void getLeftState() {
        assertTrue(state.getLeftState() instanceof RightRobotState);
    }

    @Test
    void getRightState() {
        assertTrue(state.getRightState() instanceof LeftRobotState);
    }
}