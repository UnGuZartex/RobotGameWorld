...
class TurnLeftActionTest {
    ...
    @Test
    void getName() {
        assertEquals("Turn Left", turnLeftAction.getName());
    }

    @Test
    void execute_up() {
        assertEquals("UP", levelUp.getRobot().getDirection());
        turnLeftAction.execute(levelUp);
    ...
    void execute_down() {
        ...
        turnLeftAction.execute(levelDown);
    ...
    void execute_left() {
        ...
        turnLeftAction.execute(levelLeft);
    ...
    void execute_right() {
        ...
        turnLeftAction.execute(levelRight);
